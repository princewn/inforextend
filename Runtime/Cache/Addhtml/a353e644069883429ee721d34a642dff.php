...
$(document).ready(
	function addNav(){
		var navBar='<li id = "daohanglanProduct"><a href="__URL__/Index/product.html" style="color:#fff;"><span class="glyphicon glyphicon-wrench" ></span>&nbsp;自定制'+$("title").html()+'</a></li>';
		var result=$(".nav:first").append(navBar);//此处id选择失败
		var test=$("#blockTitle").html();
		alert(test);
		alert("after test");
	}
);
