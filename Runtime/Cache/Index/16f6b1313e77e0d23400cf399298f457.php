...
<div id="introproduct" style="width:100%;">
	<div class="container" style="margin-top:-20px;" >
		<div class="row">
         	<div class="col-xs-12" >
  				<p style="line-height:180px;">产品介绍</p>
...
<div class="col-xs-9">
	 <?php if(is_array($data)): foreach($data as $key=>$v): ?><h3 id="section-<?php echo ($v['id']); ?>" style="font-family:微软雅黑;"><?php echo ($v["name"]); ?></h3><br>
          <p style="text-align:center;"> <img src="/Public/infor/Uploads/<?php echo ($v["picture"]); ?>" style="width:300px;height:200px; margin:0 auto;"/></p>
            <p style="line-height:30px; "><font size="3px" >&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($v["function"]); ?><br>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($v["technology"]); ?><br>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($v["introduction"]); ?><br></font></p>
