...
<div id="main">
			...
			<div class="container" >
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						<li id = "daohanglanPeople2"><a href="index.html" style="font-size:18px;">&nbsp;&nbsp;首页&nbsp;&nbsp;</a></li>
						<li id = "daohanglanPeople2"><a href="__URL__/Index/team.html"><span class="glyphicon glyphicon-globe" ></span>&nbsp;工作室</a></li>
						<li id = "daohanglanPeople"><a href="__URL__/Index/people.html" style="color:#fff;"><span class="glyphicon glyphicon-user" ></span>&nbsp;团队成员</a></li>
						<li id = "daohanglanPeople2"><a href="__URL__/Index/product.html" ><span class="glyphicon glyphicon-wrench" ></span>&nbsp;产品展示</a></li>
						<li id = "daohanglanPeople2">
						<a href="__URL__/Index/technology.html"><span class="glyphicon glyphicon-gift" ></span>&nbsp;技术分享</a></li>
					</ul>
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown" id = "daohanglanPeople2" >
	...
	<div id="intropeople" style="width:100%;">
		<div class="container" style="margin-top:-20px;" >
			<div class="row">
				<div class="col-xs-12" >
					<p style="line-height:180px;">团队介绍</p>
					<p style="margin-top:-60px;font-size:30px;">这是一个奋发向上的团队，一个拼搏进取的团队，一个不断前进的团队！</p>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-9">
				<?php if(is_array($data)): foreach($data as $key=>$v): ?><h3 id="section-<?php echo ($v['id']); ?>" style="font-family:微软雅黑;"><?php echo ($v["name"]); ?><img src="/Public/infor/Uploads/<?php echo ($v["picture"]); ?>" style="width:100px;height:100px; float:right;"></h3><br>
					
					<p style="line-height:30px; font-family:微软雅黑;" ><font size="3px"  >&nbsp;&nbsp;&nbsp;&nbsp;<b>专业：</b><?php echo ($v["professional"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>电话：</b><?php echo ($v["contact"]); ?><br>&nbsp;&nbsp;&nbsp;&nbsp;<b>爱好：</b><?php echo ($v["hobby"]); ?><br>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($v["pcharacter"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($v["plan"]); ?></font></p>
